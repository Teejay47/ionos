 ...
 luckyNumberToggle.addEventListener('click', () => {
   ...
   luckyNumberToggle.title = isPassword ? 'Lucky Number verstecken' : 'Lucky Number anzeigen';
 });
 luckyNumberInput.type = 'password';
 eyeOpenPaths.forEach(p => p.style.display = 'none');
 eyeClosedPaths.forEach(p => p.style.display = 'block');
 luckyNumberToggle.title = 'Lucky Number anzeigen';
 ...
 confirmLuckyNumberToggle.addEventListener('click', () => {
   ...
   confirmLuckyNumberToggle.title = isPassword ? 'Lucky Number verstecken' : 'Lucky Number anzeigen';
 });
 ...
 confirmLuckyNumberToggle.title = 'Lucky Number anzeigen';
